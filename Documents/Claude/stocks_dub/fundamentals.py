...
CACHE_VERSION = 2  # bump this whenever new fields are added
...
def fetch_fundamentals(ticker: str) -> dict:
    ...
    try:
        ...
        fin = t.financials  # columns = most recent first
        ...
        try:
            ...
            # Trend: positive = growth accelerating, negative = decelerating
